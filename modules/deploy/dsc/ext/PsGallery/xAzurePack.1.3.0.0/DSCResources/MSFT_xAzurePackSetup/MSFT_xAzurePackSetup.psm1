    ...
    switch($Component)
    {
        "MgmtSvc-PowerShellAPI"
        {
            return @(
                ...
                "{9AF631FF-CE1F-481F-9B05-D88D5BDE6CF3}",
                "{AD89FCD8-868C-4FDA-910F-9F888BF687FD}",
        ...
        "MgmtSvc-WebAppGallery"
        {
            return @(
                ...
                "{C4E6A478-2DCD-47C2-BE94-CD29FBD3C7E8}",
                "{7B69C3FB-1789-4F6F-9737-61785B3A190C}",
        ...
        "MgmtSvc-Monitoring"
        {
            return @(
                ...
                "{53C0310D-097D-46CA-A766-C3E87931ECF4}",
                "{7759F5CB-0DE5-4AE9-BF29-EF6F2D1D214A}",
        ...
        "MgmtSvc-Usage"
        {
            return @(
                ...
                "{3F4E4AED-6955-4690-B7EF-FFBBDB7CB471}",
                "{CD94B684-BF21-45B7-BBB2-A05478AB05F7}",
        ...
        "MgmtSvc-AdminAPI"
        {
            return @(
                ...
                "{1675BB48-4805-4FF0-B973-64D75292C410}",
                "{E00081AD-CE78-4F2A-9CD2-8833C15F490B}",
        ...
        "MgmtSvc-TenantAPI"
        {
            return @(
                ...
                "{A0F1EB25-B0A7-4774-8556-D42CC9C274C0}",
                "{66D13937-01D3-413B-89EA-9C38FC8EEDE6}",
        ...
        "MgmtSvc-TenantPublicAPI"
        {
            return @(
                ...
                "{6F996F63-3332-4356-9CCF-5E22653796BC}",
                "{E741DC5B-3DBF-4882-A029-6E089FA76B71}",
        ...
        "MgmtSvc-SQLServer"
        {
            return @(
                ...
                "{59360F27-E25F-467C-BA58-FC3D9ADA9C1B}",
                "{6D0C8DE3-B386-4D13-B5C7-4B513CF272AF}",
        ...
        "MgmtSvc-MySQL"
        {
            return @(
                ...
                "{5593C408-CEC3-4E60-88DF-672DC14311AB}",
                "{7D37EA03-C7CE-406A-8B15-5D722F7F0F7D}",
        ...
        "MgmtSvc-AdminSite"
        {
            return @(
                ...
                "{78E55590-A6C7-4D4A-A7FA-640242F19EF3}",
                "{7C76D912-7CC3-4644-BC36-E2715D14C7FC}",
        ...
        "MgmtSvc-WindowsAuthSite"
        {
            return @(
                ...
                "{7BD73C40-4276-4C9D-9C00-B2B591FF87A8}",
                "{9B74B70D-9D6F-4531-AC74-0A10329B0E45}",
        ...
        "MgmtSvc-TenantSite"
        {
            return @(
                ...
                "{7756023B-9368-46CC-AB7D-304655031F75}",
                "{E71A1932-C6DC-4522-B93A-131A3C7AB347}",
        ...
        "MgmtSvc-AuthSite"
        {
            return @(
                ...
                "{5A064009-39C2-4694-A92F-FFF1473CC978}",
                "{C45CE895-84AD-4B9C-AEE3-F3112381FB17}",
        ...
        "MgmtSvc-ConfigSite"
        {
            return @(
                ...
                "{282F6FAA-E6F1-4910-8A64-F20453944ACA}",
                "{FA421F0C-4E2C-4721-B190-0AED841503D3}",
